...
class Settings_model extends CI_Model
{
    ...
    public function getStockUsingDescByID($id)
    {
    ...
    public function addUsingStockDesc($data)
    {
        if ($data) {
    ...
    public function updateStockUsingDesc($id, $data = array())
    {
        if($data) {
    ...
    public function deleteStockUsingDesc($id)
    {
        if ($this->db->delete("position", array('id' => $id))) {
            return true;
        }
        return FALSE;
    }
