                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-condensed table-striped">
						<thead>
							<tr class="info-head">
								...
								<th style="width:150px;"><?= lang("total_cost"); ?></th>
					 ...
					 <?php 
					     $Tqty=0;$t_cost=0;$t_tax=0;$total_cost=0;
					   foreach($query as $q){
						   $Tqty += $q->quantity;
						   $t_cost += $q->unit_cost;
						   $t_tax += $q->item_tax;
                           $total_cost += $q->unit_cost * $q->quantity;
  					 ?>
						       <tr>
							       <td></td>
							       ...
							       <td class="text-right"><?= $this->erp->formatMoney($q->unit_cost)?></td> 
								   ...
								   <td class="text-right"><?= $this->erp->formatMoney($q->unit_cost * $q->quantity)?></td> 
							   </tr> 
					   <?php } ?>
					           <tr> 
							       <td></td>
                                   ...
                                   <td></td>
							       <td class="text-right"><?=$this->erp->formatMoney($t_cost) ?></td> 
                                   <td class="text-center"><?=$Tqty ?></td> 
                                   <td class="text-center"></td> 
								   <td class="text-right"><?=$this->erp->formatMoney($total_cost) ?></td> 
							   </tr>
					   <?php
                           $g_qty += $Tqty;
						   $g_cost += $t_cost;
					...
					<tfoot>
					           <tr style="background:#428BCA; color:white; font-size:16px !important;"> 
                                   ...
                                   <td></td>
							       <td class="bold text-right"><?=$this->erp->formatMoney($g_cost) ?></td> 
                                   <td class="bold text-center"><?=$g_qty ?></td> 
                                   <td class="bold text-center"></td> 
								   <td class="bold text-right"><?=$this->erp->formatMoney($g_subtotal) ?></td> 
							   </tr>
					</tfoot> 
