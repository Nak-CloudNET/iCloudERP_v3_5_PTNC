                                ...
                                <?php if ($Owner) { ?>
                                    <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) != 'settings' ? '' : 'mm_pos' ?>">
                                        ...
                                        <ul>
											...
											<li id="system_settings_using_stock_desc">
												<a href="<?= site_url('system_settings/using_stock_desc') ?>">
													<i class="fa fa-sitemap"></i><span class="text"> <?= lang('using_stock_desc'); ?></span>
												</a>
											</li>
